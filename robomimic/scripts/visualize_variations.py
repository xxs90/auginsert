...
class DataCollectionEnv():
    ...
    def save_render(self, img_name='render.png'):
        img = self.env.render(mode="rgb_array", height=480, width=640, camera_name="frontview")
        cv2.imsave(img, 'imgs/'+img_name)
