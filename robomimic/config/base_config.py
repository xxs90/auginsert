...
class BaseConfig(Config):
    ...
    def experiment_config(self):
        ...
        self.experiment.rollout.rollout_seed = None                 # rollout on deterministic initial configurations
    ...
    def train_config(self):
        ...
        # number of trajectory clones per human demo to use in dataset (0 for pure human demo dataset)
        self.train.num_traj_clones = 0
    ...
    def observation_config(self):
        ...
        self.observation.modalities.obs.ft = [
